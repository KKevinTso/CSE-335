...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hw11_-_composite_pattern.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hw11_-_composite_pattern.exe: ${OBJECTFILES}
